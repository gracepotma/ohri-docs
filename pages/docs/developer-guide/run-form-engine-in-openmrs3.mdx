...
Presently, [OpenMRS 3.x](https://dev3.openmrs.org/openmrs) (O3) ships the [O3 React Form Engine](https://github.com/openmrs/openmrs-form-engine-lib).
...
- Fork and clone the [O3 form engine](https://github.com/openmrs/openmrs-form-engine-lib) repository.
- `cd` into your clone.
- `pwd` to get the path of the O3 form engine , which you will use later. You should see something like
  ```
